...
filters:
  ...
  # assignee: "concerto"          # only issues assigned to this user (name, email, or "me")
claude:
  command: claude -p
  model: sonnet
...
5.  Ensure the workpad includes a compact environment stamp at the top as a code fence line:
    ...
    - Example: `devbox-01:/home/dev-user/code/concerto-workspaces/MT-42@7bdde33bc`
...
8.  Attach PR URL to the issue (prefer attachment; use the workpad comment only if attachment is unavailable).
    - Ensure the GitHub PR has label `concerto` (add it if missing).
...
- Required PR metadata is present (`concerto` label).
