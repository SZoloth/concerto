defmodule SymphonyElixir.Orchestrator do
  ...
  # Claude app_server emits :claude_pid in port metadata
  defp claude_app_server_pid_for_update(_existing, %{claude_pid: pid})
       when is_binary(pid),
       do: pid
  ...
  defp summarize_claude_update(update) do
    ...
    base
    |> maybe_put_if_present(update, :details)
    |> maybe_put_if_present(update, :total_cost_usd)
    |> maybe_put_if_present(update, :usage)
    |> maybe_put_if_present(update, :reason)
  end
